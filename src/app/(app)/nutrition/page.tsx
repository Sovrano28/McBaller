    ...
    <div className="container mx-auto">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          Fuel your performance with meal plans designed for Nigerian
          footballers using local foods
        </p>
      </div>
      ...
      <Card className="mt-8">
        <CardHeader>
          <CardTitle className="font-headline">
            Nigerian Foods in Our Plans
          </CardTitle>
          <CardDescription>
            All our nutrition plans feature locally available foods that are
